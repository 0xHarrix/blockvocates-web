...
import Checkout from './CheckoutKerala';

const KeralaBlockvocates = () => {
  return (
    <div className="container">
      <Box padding="30px">
        ...
        >
          Welcome to Kerala <span style={{ color: "#00BAE2" }}>Blockvocates</span>
        </Heading>
...
export default KeralaBlockvocates;
