...
import { Box, Heading, Text, Button, Input, useBreakpointValue, useToast } from "@chakra-ui/react";
  ...
  return (
    <div className="container">
      ...
      >
        ...
        <Button colorScheme='green' mt="4" onClick={() => handleCompleteMission('mission111')}>Mark as Complete</Button>
      </Box>
    </div>
  );
};
